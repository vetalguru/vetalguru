...
- 📚 **[CMake Project Template](https://github.com/vetalguru/cmake_project)** — A typical CMake project template
- ✅ **[CRC Checksum](https://github.com/vetalguru/checksum)** — Cyclic Redundancy Check (header only)
- 🐳 **[Yocto Build](https://github.com/vetalguru/yocto_build)** — Yocto build in different docker
- 💬 **[Telegram Bot Sample](https://github.com/vetalguru/telegram_bot)** — Telegram bot sample
